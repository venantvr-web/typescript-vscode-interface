...
wscat -c ws://localhost:3000 -x '{"requestId":"7026","command":"execute-command","shellCommand":"PYTHONPATH=$PYTHONPATH:/home/rvv/PycharmProjects/Python.VsCode.Interface"}'
sleep 5

wscat -c ws://localhost:3000 -x '{"requestId":"7026","command":"execute-command","shellCommand":"PYTHONPATH=$PYTHONPATH:/home/rvv/PycharmProjects/Python.VsCode.Interface pytest tests --json-report --json-report-file=test_results.json"}'
sleep 5

# BROKEN SANS PATH : wscat -c ws://localhost:3000 -x '{"requestId":"7026","command":"execute-command","shellCommand":"pytest-3 --json-report --json-report-file=test_results.json"}'
# sleep 5
